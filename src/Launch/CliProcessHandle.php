...
/**
 * The default {@see ProcessHandle} — control over a local process spawned with
 * `proc_open` by {@see CliLauncher}. Wraps the `proc_open` resource and its pipes,
 * drains buffered output, and cleans up the payload transport on completion.
 *
 * @see ProcessHandle
 * @see CliLauncher
 */
